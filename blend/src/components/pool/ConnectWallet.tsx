    ...
    <Wrapper>
      ...
      <div className='flex flex-col gap-y-2 mb-8'>
        <Display size='M' weight='semibold'>
          Connect your wallet to start investing with Aloe
        </Display>
        <Text size='S' weight='medium' color='rgba(204, 223, 237, 1)'>
          By investing with Aloe, you will be able to earn trading fees on Uniswap, collect interest from other
          protocols, and autonomously manage your portfolio.
        </Text>
      </div>
      <ConnectWalletButton
        address={address}
