  ...
  return (
    <div className='p-8'>
      ...
      <div className='grid grid-cols-6 gap-8 items-end mt-16'>
        <FilledGradientButton size='L' disabled>
          Label
        </FilledGradientButton>
        <FilledGradientButton size='M' disabled>
          Label
        </FilledGradientButton>
        <FilledGradientButton size='S' disabled>
          Label
        </FilledGradientButton>
        <FilledGreyButton size='L' disabled>
          Label
        </FilledGreyButton>
        <FilledGreyButton size='M' disabled>
          Label
        </FilledGreyButton>
        <FilledGreyButton size='S' disabled>
          Label
        </FilledGreyButton>
        <OutlinedGradientButton size='L' disabled>
          Label
        </OutlinedGradientButton>
        <OutlinedGradientButton size='M' disabled>
          Label
        </OutlinedGradientButton>
        <OutlinedGradientButton size='S' disabled>
          Label
        </OutlinedGradientButton>
        <OutlinedWhiteButton size='L' disabled>
          Label
        </OutlinedWhiteButton>
        <OutlinedWhiteButton size='M' disabled>
          Label
        </OutlinedWhiteButton>
        <OutlinedWhiteButton size='S' disabled>
          Label
        </OutlinedWhiteButton>
        <FilledStylizedButton size='L' disabled>
          Label
        </FilledStylizedButton>
        <FilledStylizedButton size='M' disabled>
          Label
        </FilledStylizedButton>
        <FilledStylizedButton size='S' disabled>
          Label
        </FilledStylizedButton>
        <OutlinedGradientRoundedButton size='L' disabled>
          Label
        </OutlinedGradientRoundedButton>
        <OutlinedGradientRoundedButton size='M' disabled>
          Label
        </OutlinedGradientRoundedButton>
