export const LenderABI = [
  ...
  },
  {
    inputs: [],
    name: 'borrowBase',
    outputs: [{ internalType: 'uint184', name: '', type: 'uint184' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint16', name: 'cut', type: 'uint16' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'contract RateModel', name: 'rateModel_', type: 'address' },
      { internalType: 'uint8', name: 'reserveFactor_', type: 'uint8' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
