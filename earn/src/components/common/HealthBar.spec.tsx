...
describe('HealthBar', () => {
  ...
  it('renders the health label with a plus sign when health is greater than MAX_HEALTH', () => {
    render(<HealthBar health={4} />);
    expect(screen.getByText('3+')).toBeInTheDocument();
  });

  it('renders the health dial at the correct position when health is equal to MAX_HEALTH', () => {
