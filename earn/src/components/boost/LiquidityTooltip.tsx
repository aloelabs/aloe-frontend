...
const TestTooltipContainer = styled.div.attrs((props: { offset: number }) => props)`
...
export default function LiquidityTooltip(props: {
  active: boolean;
