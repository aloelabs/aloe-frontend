...
const TOKEN1_COLOR_UNISWAP = 'rgb(187, 163, 247)';
const TOKEN1_COLOR_INTEREST_BEARING = 'rgb(134, 94, 242)';
const TOKEN1_COLOR_RAW = 'rgb(96, 2, 238)';
...
export default function LendPieChartWidget(props: LendPieChartWidgetProps) {
  ...
  const slices: LendPieChartSlice[] = [
    {
      index: 0,
      percent: 0.25,
      color: COLORS[0],
          ...
          <PieChartLabel>
            {activeSlice && (
              <div className='flex flex-col justify-center items-center gap-1'>
                <Text size='S' weight='bold'>{activeSlice.tokenBalance} {activeSlice.tokenTicker}</Text>
