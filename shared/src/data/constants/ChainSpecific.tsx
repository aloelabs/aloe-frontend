...
import {
  ...
  ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_OPTIMISM,
  ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_BASE,
  ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_ARBITRUM,
} from './Addresses';
...
export const ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS: { [chainId: number]: Address } = {
  [optimism.id]: ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_OPTIMISM,
  [arbitrum.id]: ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_ARBITRUM,
  [base.id]: ALOE_II_BORROWER_NFT_SIMPLE_MANAGER_ADDRESS_BASE,
};
