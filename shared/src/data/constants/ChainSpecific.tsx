...
import {
  ...
  MULTICALL3_ADDRESS,
  UNISWAP_FACTORY_ADDRESS_ARBITRUM,
  UNISWAP_FACTORY_ADDRESS_BASE,
  UNISWAP_FACTORY_ADDRESS_OPTIMISM,
...
export const UNISWAP_FACTORY_ADDRESS: { [chainId: number]: Address } = {
  [optimism.id]: UNISWAP_FACTORY_ADDRESS_OPTIMISM,
  [arbitrum.id]: UNISWAP_FACTORY_ADDRESS_ARBITRUM,
  [base.id]: UNISWAP_FACTORY_ADDRESS_BASE,
};
